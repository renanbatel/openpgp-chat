...
templates['message'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <li class=\"home-main_message-row row-content "
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.from : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
